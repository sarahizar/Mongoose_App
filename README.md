...
*****************Mongoose and MongoDB are related but serve different purposes. MongoDB is a NoSQL database, and Mongoose is an Object Data Modeling (ODM as we call it) library for MongoDB and Node.js.

Mongoose Advt: Schema Validation, Middlewear Support, Promises and Callbacks, Poplulation

Mongo DV Advt: Scalability, Document Oriented, No predefined Schema
---
